...
object CodexTelemetryPairing {
    const val SCHEME = "codexbar"
    const val HOST = "codex-telemetry-pair"
    const val PROTOCOL_VERSION = 1

    fun parse(input: String): CodexTelemetryCredential {
        ...
        return CodexTelemetryCredential(
            host = address,
            port = port,
    ...
    fun validate(credential: CodexTelemetryCredential) {
